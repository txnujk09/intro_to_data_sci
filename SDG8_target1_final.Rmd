...
(Here we will load: continents-according-to-our-world-in-data.csv, gdp-per-capita-worldbank.csv, Also, create a dataframe of all the 44 UN designated LDCs, Dec 2024 Compute GDP per Capita growth and compile all the information into one database)
